...
/// We also assume that $user, $course, $currenttab have been set
    ...
    /// Can only edit profile if it belongs to user or current user is admin and not editing primary admin
        ...
        //now add classification tab
        $toprow[] = new tabobject('taotopicsinterest', $wwwroot.'/local/user/classify.php?id='.$user->id.'&amp;course='.$course->id, get_string('taotopicsinterest','local'));
