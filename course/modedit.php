...
//  adds or updates modules in a course using new formslib
    ...
    if (!empty($add)) {
        ...
        $form->trackprogress    = $cm->trackprogress;          // Whether tracked by Progress Indicator
    ...
    if ($mform->is_cancelled()) {
        ...
        if (!empty($fromform->update)) {
            ...
            if(empty($fromform->trackprogress)){$fromform->trackprogress=0;}
            set_coursemodule_trackprogress($fromform->coursemodule, $fromform->trackprogress);
