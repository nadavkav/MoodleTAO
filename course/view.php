...
//  Display the course home page.
    ...
    // look for a custom login handler  
    if (function_exists('local_require_login') ) {
        local_require_login($course);
    } else {
    ...
    // ====== Change to Core ======== //
    // local handling of parameters
    if (function_exists('local_course_parameter_handler')) {
        local_course_parameter_handler();
    }
    // ===== End Change to Core ====== //
    ...
    // ====== Change to Core ======== //
    $buttons = '';
    // look for custom buttons for this course format
    if (function_exists('local_course_buttons')) {
        $buttons = local_course_buttons($course);
    }

    $PAGE->print_header(get_string('course').': %fullname%', NULL, '', $bodytags, $buttons);
    // ===== End Change to Core ====== //
