...
class moodleform_mod extends moodleform {
    ...
    function standard_coursemodule_elements($features=null){
        ...
        if (!isset($this->_features->trackprogress)) {
            $this->_features->trackprogress = true;
        }
        ...
        if ($this->_features->trackprogress) {
            $mform->addElement('checkbox', 'trackprogress', get_string('trackprogress', 'local'));
        }
