 ...
 */
	class tNG_CheckTableField {
		...
		/**
			...
			* Patched by Joel 28/9/07 as per:
			* 	http://www.interaktonline.com/Products/Dreamweaver-Extensions/FormValidation/Product-Forum/Details/103550/CheckUnique+-+Suggestion+::+optional+parameter+%5C%22extra_sql%5C%22.html
		...
		function tNG_CheckTableField(&$tNG) {
			...
			$this->value = -1;
			$this->extraSQL = ''; // patched by Joel
			$this->errorMsg = '';
			$errorIfExists = false;
		}

		function setExtraSQL($extraSQL) {
