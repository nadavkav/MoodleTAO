<?php
	...
	// Protect against missing user session, e.g. public shares
	if (strlen($_SESSION['USER']->id)) {
		...
		$user_dark_colour = $skin_data->getSkinHtmlColour("pieChartBackgroundColour");
		$user_bright_colour = $skin_data->getSkinHtmlColour("pieChartCompleteColour");
	} else {
		// Default colors
		$user_dark_colour = '58585A';
		$user_bright_colour = 'F79448';
	}
?>
...
config. BgColor 		= '#<?php echo $user_bright_colour; ?>' // Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#<?php echo $user_dark_colour; ?>'
