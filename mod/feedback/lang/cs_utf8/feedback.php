<?PHP // $Id: feedback.php,v 1.1.6.1 2008/02/24 21:30:11 mudrd8mz Exp $ 
      // feedback.php - created with Moodle 1.9 Beta 4 (2007101508)
      // local modifications from http://localhost/~mudrd8mz/moodle-19-stable
...
$string['all_old_values_will_be_deleted'] = 'Stávající otázky a odpovědi všech uživatelů budou odstraněny';
$string['all_old_values_will_be_preserved'] = 'Dosavadní otázky a přiřazené odpovědi budou zachovány';
$string['all_related_values_will_be_deleted'] = 'Odpovědi uživatelů na tuto otázku budou rovněž odstraněny';
...
$string['are_you_sure_to_delete_this_entry'] = 'Jste si jistí, že chcete odstranit tento záznam?';
$string['are_you_sure_to_delete_this_item'] = 'Jste si jistí, že chcete smazat tuto položku?';
$string['are_you_sure_to_delete_this_template'] = 'Jste si jistí, že chcete smazat tuto šablonu?';
$string['are_you_sure_to_use_this_template'] = 'Jste si jistí, že chcete použít tuto šablonu?';
...
$string['feedback:deletecompleteds'] = 'Odstraňovat vyplněné dotazníky';
