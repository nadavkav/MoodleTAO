<?php // $Id: complete.php,v 1.5.2.6 2008/07/30 18:57:20 agrabs Exp $
/**
* prints the form so the user can fill out the feedback
*
* @version $Id: complete.php,v 1.5.2.6 2008/07/30 18:57:20 agrabs Exp $
    ...
    if($feedback_can_submit) {
        ...
        if($preservevalues == 1){
            ...
            if(feedback_check_values($post, $startitempos, $lastitempos)) {
                    $userid = $USER->id; //arb
                if($completedid = feedback_save_values($post, $USER->id, true)){
                    if($userid > 0) {
