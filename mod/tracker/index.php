<?PHP // $Id: index.php,v 1.1.10.3 2008/10/07 20:06:23 diml Exp $
...
/// Print the list of instances (your module will probably extend this)
    ...
    foreach ($trackers as $tracker) {
        if (!$tracker->visible) {
            ...
            $link = "<a class=\"dimmed\" href=\"view.php?id={$tracker->coursemodule}\">{$tracker->name}</a>";
        } else {
            //Show normal if the mod is visible
            $link = "<a href=\"view.php?id={$tracker->coursemodule}\">{$tracker->name}</a>";
        }
