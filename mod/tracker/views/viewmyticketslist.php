...
if(!empty($tracker->parent)){
    ...
    $tableheaders = array("<b>$issuenumberstr</b>", "<b>$summarystr</b>", "<b>$datereportedstr</b>", "<b>$assignedtostr</b>", "<b>$statusstr</b>", "<b>$watchesstr</b>", "<b>$actionstr</b>");
}
...
<table border="1">
    <tr>
        <td colspan="5" align="center">
            <?php print_string('notickets', 'tracker'); ?>
        </td>
    </tr>
</table>
<?php
