...
if ($action == 'createelement'){
	...
	include ('classes/trackercategorytype/editelement.html');
	return -1;
}
/************************************* add an element *****************************/
...
elseif ($action == 'editelement'){
	...
	if ($form->elementid != null){
		...
		include ('classes/trackercategorytype/editelement.html');
		// include ('classes/trackercategorytype/' . $form->type . '/edit' . $form->type . '.html');
	}
	else{
...
if ($action == 'viewelementoptions'){
	...
	if ($form->elementid != null){
        ...
        include("$CFG->dirroot/mod/tracker/classes/trackercategorytype/editoptionform.html");
		// include ('classes/trackercategorytype/' . $form->type . '/add' . $form->type . 'option.html');
	}
	else{
...
if ($action == 'editelementoption'){
	...
	include_once ('classes/trackercategorytype/updateoptionform.html');
	return -1;
}
/************************************* edit an element option *****************************/
if ($action == 'updateelementoption'){
    ...
    if (!count($errors)){
    	...
    	if (update_record('tracker_elementitem', $update)){
            ...
            print_heading(get_string('addanoption', 'tracker'));
	        include_once ('classes/trackercategorytype/editoptionform.html');
    	}
    	else{
