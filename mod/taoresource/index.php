 ...
 */
    ...
    add_to_log($course->id, "taoresource", "view all", "index.php?id=$course->id", "");

    $strresource = get_string("modulename", "taoresource");
    $strresources = get_string("modulenameplural", "taoresource");
    ...
    if (! $resources = get_all_instances_in_course("taoresource", $course)) {
