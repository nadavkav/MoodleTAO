...
class auth_plugin_mnet extends auth_plugin_base {
    ...
    function mnet_publishes() {
        ...
        $sso_idp['methods']     = array('user_authorise','keepalive_server', 'kill_children',
                                        ...
                                        'update_enrolments', 'get_user_profile_fields');
     ...
     */
    function start_jump_session($mnethostid, $wantsurl, $fromurl) {
        global $CFG;
        global $USER;
        global $MNET;
        ...
        $url = "{$mnet_peer->wwwroot}{$mnet_peer->application->sso_land_url}?token={$mnet_session->token}&idp={$MNET->wwwroot}&wantsurl={$wantsurl}&fromurl={$fromurl}";
