...
/// Print out the tabs
    ...
    if (has_capability('moodle/local:messagebyrole', get_context_instance(CONTEXT_COURSE, SITEID))) {
        $tabrow[] = new tabobject('byrole', $CFG->wwwroot .'/message/index.php?tab=byrole',
            get_string('messagebyrole', 'local')
        );
    }
