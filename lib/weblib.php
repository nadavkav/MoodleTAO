...
function switchroles_form($courseid) {
    ...
    if (has_capability('moodle/role:switchroles', $context, null, false)) { //TAOEDIT:WR#63854: so that we can prevent admins from having switchrole at course contextlevel
